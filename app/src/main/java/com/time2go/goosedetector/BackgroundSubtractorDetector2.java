...
public final class BackgroundSubtractorDetector2 extends BaseDetector implements IDetector {
    ...
    public BackgroundSubtractorDetector2(int history, float threshold, double shadowDetect, File mediaDir, int HSVproximity) {
    ...
    public Mat detect(Mat source) {
        ...
        //Imgproc.threshold(fgMask, fgMask, mShadowDetect-1, 255, Imgproc.THRESH_BINARY);
